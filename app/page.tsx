...
export default function LandingPage() {
  return (
    <main className="launch-page">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "SoftwareApplication", name: "Nexus", applicationCategory: "BusinessApplication", operatingSystem: "Web", description: "Competitor price and stock monitoring for e-commerce teams.", offers: [{ "@type": "Offer", name: "Starter", price: "99", priceCurrency: "EUR" }, { "@type": "Offer", name: "Business", price: "649", priceCurrency: "EUR" }, { "@type": "Offer", name: "Pro", price: "1749", priceCurrency: "EUR" }] }) }} />
      <nav className="launch-nav" aria-label="Main navigation">
        <Link className="launch-logo" href="/"><span><Bolt size={16}/></span>Nexus</Link>
      ...
      <section className="launch-hero">
        <div className="hero-copy">
          ...
          <p>Nexus checks competitor product pages, records price and stock changes, and tells you exactly when it is time to act.</p>
        ...
        <div className="hero-product" id="product-demo" aria-label="Nexus dashboard preview">
          <div className="demo-top"><div className="demo-brand"><span><Bolt size={12}/></span>Nexus</div><div className="demo-search">⌕ &nbsp; Search products</div><div className="demo-avatar">AK</div></div>
      ...
      <section className="launch-section" id="how-it-works"><div className="section-intro"><span className="section-label">A SIMPLE DAILY ADVANTAGE</span><h2>From website and EAN to<br/>a verified product match.</h2><p>Add one product or import an entire Excel catalogue.</p></div><div className="steps"><article><span>01</span><div className="step-icon">↗</div><h3>Enter website, name &amp; EAN</h3><p>Give Nexus the public store website, exact product name, and barcode identifier.</p></article><article><span>02</span><div className="step-icon">⌁</div><h3>We search public pages</h3><p>Nexus checks likely same-site pages, prioritizes exact EAN matches, and captures price and stock when available.</p></article><article><span>03</span><div className="step-icon">⇩</div><h3>Import or export Excel</h3><p>Upload multiple products from the template, then export the catalogue with match status and latest results.</p></article></div></section>

      <section className="value-section"><div><span className="section-label light">DESIGNED FOR DECISIONS</span><h2>Your market, without<br/>the manual checking.</h2><p>Nexus turns scattered public product pages into a useful daily operating signal.</p><ul><li><Check/><span><b>Price history that compounds</b>Build a reliable record of every observed change.</span></li><li><Check/><span><b>Alerts with context</b>See your price, their price, and the exact difference.</span></li><li><Check/><span><b>Stock intelligence</b>Know when competitor inventory disappears or returns.</span></li></ul></div><div className="alert-stack"><article><span className="alert-arrow down-arrow">↓</span><div><small>PRICE DROP · 18 MIN AGO</small><b>TechNest lowered MX Master 4</b><p>€119.99 <s>→</s> <strong>€109.99</strong></p></div><em>−8.3%</em></article><article><span className="alert-arrow check-arrow">✓</span><div><small>RESTOCK · 2 HOURS AGO</small><b>GadgetHub is back in stock</b><p>Keychron Q6 Max · <strong>€229.00</strong></p></div></article><article><span className="alert-arrow rise-arrow">↑</span><div><small>PRICE INCREASE · YESTERDAY</small><b>ElectroMart raised MX Master 4</b><p>€126.00 <s>→</s> <strong>€129.00</strong></p></div><em className="coral-text">+2.4%</em></article></div></section>

      <section className="responsible-section" id="responsible"><div className="responsible-mark"><Bolt size={25}/></div><div><span className="section-label">RESPONSIBLE BY DESIGN</span><h2>Useful monitoring.<br/>Respectful collection.</h2></div><div><p>Nexus is designed for public business information and sensible monitoring—not bypassing access controls.</p><ul><li><Check/>Public product pages only</li><li><Check/>Reasonable request rates</li><li><Check/>Caching to avoid repeat fetches</li><li><Check/>No CAPTCHA or paywall bypass</li></ul></div></section>

      <section className="pricing-section" id="pricing"><div className="section-intro"><span className="section-label">CLEAR, URL-BASED PRICING</span><h2>Start small. Scale when the<br/>signal proves valuable.</h2><p>Try every plan free for 14 days. Hosting and AI-assisted monitoring are included.</p></div><div className="pricing-grid"><article><span>Starter</span><h3>€99<small>/month, excl. VAT</small></h3><p>For a focused product range.</p><ul><li><Check/>14-day free trial</li><li><Check/>50 monitored URLs</li><li><Check/>Daily price checks</li><li><Check/>Price history</li><li><Check/>AI-assisted recovery</li></ul><a href="/login?plan=starter">Start free trial</a></article><article className="featured-plan"><div className="popular">MOST POPULAR</div><span>Business</span><h3>€649<small>/month, excl. VAT</small></h3><p>For active e-commerce teams.</p><ul><li><Check/>14-day free trial</li><li><Check/>350 monitored URLs</li><li><Check/>4 checks per day</li><li><Check/>Email alerts</li><li><Check/>Stock monitoring</li></ul><a href="/login?plan=business">Start free trial</a></article><article><span>Pro</span><h3>€1,749<small>/month, excl. VAT</small></h3><p>For larger catalogues.</p><ul><li><Check/>14-day free trial</li><li><Check/>1,000 monitored URLs</li><li><Check/>Frequent checks</li><li><Check/>CSV and API export</li><li><Check/>Priority AI-assisted recovery</li></ul><a href="/login?plan=pro">Start free trial</a></article><article className="enterprise-plan"><span>Enterprise</span><h3>2,500+<small> URLs</small></h3><p>For high-volume catalogues and tailored operations.</p><ul><li><Check/>Custom monitoring capacity</li><li><Check/>Tailored check frequency</li><li><Check/>Priority onboarding</li><li><Check/>Dedicated support</li><li><Check/>Commercial terms for your scale</li></ul><a href="#contact-sales">Contact us</a></article></div><ContactForm/><p className="pricing-note"><strong>14-day free trial. No credit card required.</strong> Prices shown exclude applicable taxes. VAT is calculated at checkout based on your location and tax status.</p></section>

      <section className="faq-section"><div><span className="section-label">COMMON QUESTIONS</span><h2>Good to know<br/>before you start.</h2></div><div className="faq-list"><details><summary>Which websites can Nexus monitor?<span>+</span></summary><p>Nexus searches public store pages. It reports blocked or unsupported sites instead of trying to bypass their protections.</p></details><details><summary>What information do I enter?<span>+</span></summary><p>Each product needs a public website, a product name, and a valid EAN, UPC, or GTIN barcode. SKU, notes, and your own price are optional.</p></details><details><summary>Can I add many products?<span>+</span></summary><p>Yes. Download the Excel template and import up to 250 product–website searches per request within your plan limit.</p></details><details><summary>Can Nexus bypass blocked pages?<span>+</span></summary><p>No. It does not bypass logins, CAPTCHAs, paywalls, or intentional access controls.</p></details></div></section>
      ...
      <footer className="launch-footer"><Link className="launch-logo" href="/"><span><Bolt size={16}/></span>Nexus</Link><p>Competitive intelligence for focused e-commerce teams.</p><div><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/login">Sign in</a></div><small>© 2026 Nexus. Early access.</small></footer>
    </main>
  );
}
