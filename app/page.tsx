...
export default function LandingPage() {
  return (
    <main className="launch-page">
      ...
      <section className="pricing-section" id="pricing"><div className="section-intro"><span className="section-label">CLEAR, URL-BASED PRICING</span><h2>Start small. Scale when the<br/>signal proves valuable.</h2><p>Try every plan free for 14 days. Hosting and AI-assisted monitoring are included.</p></div><div className="pricing-grid"><article><span>Starter</span><h3>€100<small>/month</small></h3><p>For a focused product range.</p><ul><li><Check/>14-day free trial</li><li><Check/>25 monitored URLs</li><li><Check/>Daily price checks</li><li><Check/>Price history</li><li><Check/>AI-assisted recovery</li></ul><a href="/login?plan=starter">Start free trial</a></article><article className="featured-plan"><div className="popular">MOST POPULAR</div><span>Business</span><h3>€199<small>/month</small></h3><p>For active e-commerce teams.</p><ul><li><Check/>14-day free trial</li><li><Check/>150 monitored URLs</li><li><Check/>4 checks per day</li><li><Check/>Email alerts</li><li><Check/>Stock monitoring</li></ul><a href="/login?plan=business">Start free trial</a></article><article><span>Pro</span><h3>€499<small>/month</small></h3><p>For larger catalogues.</p><ul><li><Check/>14-day free trial</li><li><Check/>1,000 monitored URLs</li><li><Check/>Frequent checks</li><li><Check/>CSV and API export</li><li><Check/>Priority AI-assisted recovery</li></ul><a href="/login?plan=pro">Start free trial</a></article><CustomPlan/></div><p className="pricing-note">14 days free with no card required. Prices include platform hosting and a fair-use allowance for AI-assisted checks. Billing is not activated during early access.</p></section>
