...
export default function LandingPage() {
  return (
    <main className="launch-page">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "SoftwareApplication", name: "PriceWatch", applicationCategory: "BusinessApplication", operatingSystem: "Web", description: "Competitor price and stock monitoring for e-commerce teams.", offers: [{ "@type": "Offer", name: "Starter", price: "9", priceCurrency: "EUR" }, { "@type": "Offer", name: "Business", price: "29", priceCurrency: "EUR" }, { "@type": "Offer", name: "Pro", price: "79", priceCurrency: "EUR" }] }) }} />
      <nav className="launch-nav" aria-label="Main navigation">
        ...
        <div className="launch-actions"><a className="text-link" href="/login">Sign in</a><a className="launch-button small" href="/login">Start monitoring</a></div>
      </nav>

      <section className="launch-hero">
        <div className="hero-copy">
          <div className="launch-kicker"><span/>Early access for e-commerce teams</div>
          ...
          <div className="hero-actions"><a className="launch-button" href="/login">Start monitoring <span>→</span></a><a className="watch-demo" href="#product-demo"><span className="play">▶</span>See the product</a></div>
          <div className="hero-trust"><span><Check/>No credit card</span><span><Check/>Public pages only</span><span><Check/>Cancel anytime</span></div>
        </div>
      ...
      <section className="pricing-section" id="pricing"><div className="section-intro"><span className="section-label">CLEAR, URL-BASED PRICING</span><h2>Start small. Scale when the<br/>signal proves valuable.</h2><p>Early-access pricing for the first launch cohort.</p></div><div className="pricing-grid"><article><span>Starter</span><h3>€9<small>/month</small></h3><p>For a focused product range.</p><ul><li><Check/>25 monitored URLs</li><li><Check/>Daily price checks</li><li><Check/>Price history</li></ul><a href="/login">Choose Starter</a></article><article className="featured-plan"><div className="popular">MOST POPULAR</div><span>Business</span><h3>€29<small>/month</small></h3><p>For active e-commerce teams.</p><ul><li><Check/>150 monitored URLs</li><li><Check/>4 checks per day</li><li><Check/>Email alerts</li><li><Check/>Stock monitoring</li></ul><a href="/login">Start with Business</a></article><article><span>Pro</span><h3>€79<small>/month</small></h3><p>For larger catalogues.</p><ul><li><Check/>1,000 monitored URLs</li><li><Check/>Frequent checks</li><li><Check/>CSV and API export</li></ul><a href="/login">Choose Pro</a></article><CustomPlan/></div><p className="pricing-note">Billing is not activated during early access. Plans shown are proposed launch pricing.</p></section>

      <section className="faq-section"><div><span className="section-label">COMMON QUESTIONS</span><h2>Good to know<br/>before you start.</h2></div><div className="faq-list"><details><summary>Which websites can PriceWatch monitor?<span>+</span></summary><p>PriceWatch searches public store pages. It reports blocked or unsupported sites instead of trying to bypass their protections.</p></details><details><summary>What information do I enter?<span>+</span></summary><p>Each product needs a public website URL, a product name, and an EAN, UPC, or GTIN barcode. SKU and notes are optional.</p></details><details><summary>Can I add many products?<span>+</span></summary><p>Yes. Download the Excel template, enter one product per row, and import up to 250 rows at a time within your plan limit.</p></details><details><summary>Can PriceWatch bypass blocked pages?<span>+</span></summary><p>No. It does not bypass logins, CAPTCHAs, paywalls, or intentional access controls.</p></details></div></section>

      <section className="final-cta"><span className="section-label light">YOUR NEXT PRICE CHANGE IS COMING</span><h2>See it before it<br/>costs you margin.</h2><p>Start your workspace and search your first product by website, name, and EAN.</p><a className="launch-button inverted" href="/login">Start monitoring <span>→</span></a></section>
