...
export default function LandingPage() {
  return (
    <main className="launch-page">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "SoftwareApplication", name: "Nexus", applicationCategory: "BusinessApplication", operatingSystem: "Web", description: "Competitor price and stock monitoring for e-commerce teams.", offers: [{ "@type": "Offer", name: "Starter", price: "250", priceCurrency: "EUR" }, { "@type": "Offer", name: "Business", price: "500", priceCurrency: "EUR" }, { "@type": "Offer", name: "Pro", price: "1000", priceCurrency: "EUR" }] }) }} />
