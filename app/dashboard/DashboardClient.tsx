    ...
    <section className="content search-content">
      ...
      <section className="product-search-card" id="search-product">
        ...
        <details className="search-routing-help">
          ...
          <p>PriceWatch checks a saved product page first, then known search routes, the website&apos;s public search form, and common query parameters. If none produces a verified match, AI searches only that store for candidate pages. Every AI candidate is fetched and independently verified before its price can be saved.</p>
        </details>
        <div className="responsible-note"><Icon name="bolt" size={15}/><span>Evidence-first hybrid search: AI finds candidate URLs only; EAN, price, currency, and stock are verified from the public product page.</span></div>
      </section>
