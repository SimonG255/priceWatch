...
export const monitoredProducts = pgTable(
  "monitored_products",
  {
    ...
    alertTargetPriceCents: integer("alert_target_price_cents"),
    alertDropPercentBps: integer("alert_drop_percent_bps"),
  ...
  (table) => [
    ...
    index("monitored_products_owner_monitoring_idx").on(table.ownerEmail, table.monitoringEnabled, table.updatedAt),
...
export const customSearchProfiles = pgTable(
  "custom_search_profiles",
  {
    ...
    cookieConsentSelector: text("cookie_consent_selector").notNull().default(""),
